...
VECM model practically does not work, thus, we also cannot be sure that all other models work adequately. Most likely we shall neglect these results, especially since they add no further value 
to the period choice.
# -------------------------------------------------------------------------------------------------- #
